...
inputItem.addEventListener('input', function(event){
  ...
  if (/\s/g.test(charEntered)) {  //проверить, является ли введенный символ пробелом
    checkWord();
  }
  else{
    currentWord();
